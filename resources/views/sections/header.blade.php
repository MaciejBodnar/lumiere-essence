<header class="">
    <div class="w-full h-full bg-[#f4c8c4]">
        <div class="bg-[#f4c8c4] max-w-7xl mx-auto flex justify-between items-center">
            ...
            <a href="#booking"
                class="min-h-[60px] min-w-[256px] bg-[#EFD9D1] hover:bg-[#EFD9D1]/40 flex items-center justify-center h-full uppercase tracking-[0.25em]">
                Booking
            </a>
        </div>
    </div>
    <div class="flex flex-col items-center py-6">
        ...
        <nav class="hidden mt-8 md:flex space-x-8 text-[#7b6f69] text-sm uppercase tracking-[0.25em]">
            <a href="/" class="hover:text-[#3b2a27] transition-colors duration-300">Home</a>
