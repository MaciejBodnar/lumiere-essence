...
class HeaderFooter extends Composer
{
    ...
    private function getFooterData()
    {
        ...
        return [
            ...
            'footer_copyright_en' => $this->getAcfFieldSafe('footer_copyright_en', 'option', '2025 Lumiere Essence Skincare and Aesthetic – D&amp;C with <i class="fa-solid fa-heart" style="color: #C49090;"></i>'),
            'footer_privacy_en' => $this->getAcfFieldSafe('footer_privacy_en', 'option', 'Privacy Policy | T&amp;C'),
            'footer_privacy_url_en' => $this->getAcfFieldSafe('footer_privacy_url_en', 'option', '#'),
            ...
            'footer_copyright_pl' => $this->getAcfFieldSafe('footer_copyright_pl', 'option', '2025 Lumiere Essence Skincare and Aesthetic – D&amp;C with <i class="fa-solid fa-heart" style="color: #C49090;"></i>'),
            'footer_privacy_pl' => $this->getAcfFieldSafe('footer_privacy_pl', 'option', 'Privacy Policy | T&amp;C'),
            'footer_privacy_url_pl' => $this->getAcfFieldSafe('footer_privacy_url_pl', 'option', '#'),
