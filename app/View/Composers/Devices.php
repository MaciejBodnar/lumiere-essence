...
class Devices extends Composer
{
    /**
    ...
    private function getHeroData()
    {
        ...
        $device_rows = $this->getAcfFieldSafe('device_rows', false, []);
        ...
        if (empty($device_rows)) {
            $device = [
                [
                    ...
                    'image' => get_theme_file_uri('/resources/images/device1.png'),
                ],
                [
                    'title' => 'Dr Platon',
                    'description' => 'Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua.',
                ...
                [
                    'title' => 'Dr Platon',
                    'description' => 'Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua.',
                    'image' => get_theme_file_uri('/resources/images/device2.png'),
                ],
                [
                    'title' => 'Dr Platon',
                    'description' => 'Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua.',
        ...
        return [
            'title' => $this->getAcfFieldSafe('hero_title', false, 'Our Devices'),
            'hero_bg_image' => $this->getAcfImageSafe(
                'hero_bg_image',
                false,
                'full',
                get_theme_file_uri('/resources/images/bg-devices.png')
            ),
            'device' => $device,
        ];
    }
